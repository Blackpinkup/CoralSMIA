...
import numpy as np
import os
from data.coral import COLOR_MAP
...
from train_coral import seed_torch
import argparse

parser = argparse.ArgumentParser(description='Eval methods')
parser.add_argument('--ckpt_path',  type=str,
                    help='ckpt path', default='/home/biqi/code/business/LoveNAS-master/logs/coralmask_deeplabv3p/checkpoint-15000.pth')
parser.add_argument('--config_path',  type=str,
                    help='config path', default='baseline_coral.deeplabv3p')
...
def evaluate(ckpt_path, config_path='base.hrnetw32', use_tta=False):
    ...
    metric_op = er.metric.PixelMetric(2, logdir=log_dir, logger=logger)
    ...
    viz_op = er.api.viz.VisualizeSegmm(vis_dir, palette)
